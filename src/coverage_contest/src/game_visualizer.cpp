...
GameVisualizer::GameVisualizer(rclcpp::Node::SharedPtr node) : node_(node) {
...
//     RCLCPP_INFO(node_->get_logger(), "[Game Visualizer] Cleared game visualizer.");
// }
...
//     player_vis.marker_pub = nh_.advertise<visualization_msgs::msg::Marker>(player_vis.id + marker_topic_, 1, this);
